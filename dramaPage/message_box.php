...
<?php
	...
	if ($mode=="send")
		$sql = "select * from message where send_id='$usernick' order by num desc";
	else
		$sql = "select * from message where rv_id='$usernick' order by num desc";
   ...
   for ($i=$start; $i<$start+$scale && $i < $total_record; $i++)
   {
	  ...
	  $result2 = mysqli_query($con, "select nick from members where nick='$msg_id'");
