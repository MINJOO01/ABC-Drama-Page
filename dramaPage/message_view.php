...
<?php
	...
	if ($mode=="send")
		$result2 = mysqli_query($con, "select nick from members where nick='$rv_id'");
	else
		$result2 = mysqli_query($con, "select nick from members where nick='$send_id'");
...
?>
	    ...
	    <ul id="view_content">
			<li>
				...
				<span class="col2"><?=$msg_name?> | <?=$registDay?></span>
			</li>
			<li>
				<?=$content?>
			</li>		
